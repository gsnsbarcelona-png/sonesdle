/**
 * ParticlesComponent — portado de /dle, sin dependencias.
 * Maneja partículas de fondo flotantes + confetti de victoria/derrota.
 */
export class ParticlesComponent {
  ...
  /**
   * @param {{ particleCanvas: HTMLCanvasElement, confettiCanvas: HTMLCanvasElement }}
   */
